...
int main(void)
{
    ...
    LED_B_Write(1);             //Initialization LED_R signals IMU initialization in process. (Also if calibration is done)
    ...
    {}   
    /****LOOP****/
    LED_B_Write(0);             //This LED ensures that our IMU Initialization is done, otherwise there may be an issue with a serial connection or another thing.           
