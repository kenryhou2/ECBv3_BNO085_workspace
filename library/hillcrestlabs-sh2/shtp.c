    ...
    while (cursor < payloadLen) {
        ...
        switch (tag) {
            ...
            case TAG_GUID:
                ...
                strcpy(chanName, "");
                break;
            case TAG_MAX_CARGO_PLUS_HEADER_WRITE: //Henry:has the tag here in the input buffer
                ...
                break;
            case TAG_MAX_CARGO_PLUS_HEADER_READ: //Henry: buffer never has tag for this value.
                x = readu16(val) - SHTP_HDR_LEN;
